...
public class getKsSku implements Runnable {
    ...
    public String skuId;
    public getKsSku(String itemId,String skuId){
        this.itemId=itemId;
        this.skuId=skuId;
    }
    ...
    public static void main(String args[]){
        for (int i=0;i<1;i++) {
            getKsSku getKsSku = new getKsSku("1153115418880","1153115419880");
...
//                int skuStock= Integer.parseInt(postUtils.getSkuState(postUtils.httpGet("https://app.kwaixiaodian.com/rest/app/grocery/product/self/detail?itemId="+itemId+"&retryLimit=true", "UTF-8", cookie)));
                int skuStock= Integer.parseInt(postUtils.getSkuState(postUtils.httpGet("https://app.kwaixiaodian.com/rest/app/grocery/product/self/sku/stockAndPrice?itemId="+itemId+"&skuId="+skuId, "UTF-8", cookie)));
